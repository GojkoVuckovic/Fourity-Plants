...
export declare class WebBrowserSettings extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebBrowserSettingsState, opts?: pulumi.CustomResourceOptions): WebBrowserSettings;
    /**
     * Returns true if the given object is an instance of WebBrowserSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebBrowserSettings;
    /**
 ...
 */
export interface WebBrowserSettingsState {
    /**
     * Additional encryption context for the browser settings.
     */
 ...
 */
export interface WebBrowserSettingsArgs {
    /**
     * Additional encryption context for the browser settings.
     */
    additionalEncryptionContext?: pulumi.Input<{
