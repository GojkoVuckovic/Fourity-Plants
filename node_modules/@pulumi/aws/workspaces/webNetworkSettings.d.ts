...
export declare class WebNetworkSettings extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebNetworkSettingsState, opts?: pulumi.CustomResourceOptions): WebNetworkSettings;
    /**
     * Returns true if the given object is an instance of WebNetworkSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebNetworkSettings;
    /**
